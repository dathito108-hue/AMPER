...
class CanonicalSovereignContextSource(
    ...
    override fun capture(
        ...
        val excludedRawKinds = setOf(
            ...
            MemoryBackedNativeTrainingPipeline.TEACHER_KIND,
            MemoryBackedNativeTrainingPipeline.MANIFEST_KIND,
            MemoryBackedNativeTrainingPipeline.RUN_KIND,
            MemoryBackedNativeTrainingPipeline.OUTPUT_INDEX_KIND,
            MemoryBackedNativeTrainingPipeline.EVALUATION_KIND,
            MemoryBackedNativeTrainingPipeline.PROMOTION_KIND,
            MemoryBackedAutonomousEvolutionModel.SUITE_KIND,
            MemoryBackedAutonomousEvolutionModel.DECISION_KIND,
            MemoryBackedAutonomousEvolutionModel.PROMOTION_KIND,
            MemoryBackedAutonomousEvolutionPromotionExecutor.EXECUTION_KIND,
            ...
            MemoryBackedGoalTransferCalibrationModel.MARKER_KIND,
            MemoryBackedGoalTransferCalibrationModel.SNAPSHOT_KIND,
            MemoryBackedGoalContextualStrategyPortfolio.DECISION_KIND,
            MemoryBackedGoalContextualStrategyPortfolio.OUTCOME_MARKER_KIND,
            MemoryBackedGoalContextualStrategyPortfolio.STATS_KIND,
            MemoryBackedGoalContextualStrategyPortfolio.INDEX_KIND,
            MemoryBackedGoalHierarchicalStrategyCreditModel.STATS_KIND,
            MemoryBackedGoalHierarchicalStrategyCreditModel.OUTCOME_MARKER_KIND,
            MemoryBackedGoalHierarchicalStrategyCreditModel.PLAN_COMPONENT_INDEX_KIND,
            MemoryBackedGoalHierarchicalStrategyCreditModel.INDEX_KIND,
            MemoryBackedGoalRepairValidationModel.SNAPSHOT_KIND,
            MemoryBackedGoalRepairValidationModel.EVIDENCE_MARKER_KIND,
            MemoryBackedGoalRepairValidationModel.REQUALIFICATION_KIND,
            ...
            MemoryBackedReflexDecisionCheckpointEvaluator.EVALUATION_KIND,
            ReflexDecisionEvaluationProjectionBinding.KIND
        )

...
class AmperRuntime private constructor(
    ...
    fun agiMobileLongHorizonQualificationProbes(
        subject: AgiMobileQualificationSubject
    ...
    fun agiMobileAuthorityQualificationProbes(
        subject: AgiMobileQualificationSubject
    ): AgiMobileAuthorityProbePack =
        AgiMobileAuthorityQualificationProbes.canonical(subject)
    ...
    companion object {
        ...
        private fun build(
            ...
            val reflexDecisionEvaluation = CanonicalReflexDecisionEvaluationCoordinator(
                datasets = reflexExperienceDatasets,
                foundation = nativeModelFoundation,
                training = nativeTrainingPipeline
            )
